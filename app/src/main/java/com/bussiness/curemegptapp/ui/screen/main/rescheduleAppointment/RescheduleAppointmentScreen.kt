...
fun RescheduleAppointmentScreen(
    ...
    val memberOptions = listOf("Myself", "Jane Smith", "Alice Johnson", "Bob Williams")
    val selectedAppointmentReminderOptions = listOf("10 Min Before", "30 Min Before", "2 Hrs. Before", "24 Hrs. Before")
    ...
    Column(
        ...
        Column(
            ...
            Row(
                ...
                ContinueButton(text = "Reschedule") {
    ...
    if (showDialogSuccessFully) {
        SuccessfulDialog(
            ...
            description = "Your appointment has been updated and reminders are set.",
            onDismiss = {
